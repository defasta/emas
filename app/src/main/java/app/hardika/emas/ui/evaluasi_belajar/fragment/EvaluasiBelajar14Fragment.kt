...
import app.hardika.emas.databinding.FragmentEvaluasiBelajar14Binding
import app.hardika.emas.ui.MainViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class EvaluasiBelajar14Fragment : BaseFragment<FragmentEvaluasiBelajar14Binding>(
    FragmentEvaluasiBelajar14Binding:: inflate
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnChooseA.setOnClickListener {
            lifecycleScope.launch {
                viewModel.saveAnswerEb14("A")
            }
            val direction =
                app.hardika.emas.ui.evaluasi_belajar.fragment.EvaluasiBelajar14FragmentDirections.actionEvaluasiBelajar14FragmentToEvaluasiBelajar15Fragment()
