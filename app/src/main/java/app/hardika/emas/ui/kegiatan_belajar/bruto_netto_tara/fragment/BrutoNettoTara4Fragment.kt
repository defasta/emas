...
import app.hardika.emas.databinding.FragmentBrutoNettoTara4Binding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class BrutoNettoTara4Fragment : BaseFragment<FragmentBrutoNettoTara4Binding>(
    FragmentBrutoNettoTara4Binding:: inflate
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            ...
            val direction =
                app.hardika.emas.ui.kegiatan_belajar.bruto_netto_tara.fragment.BrutoNettoTara4FragmentDirections.actionBrutoNettoTara4FragmentToBrutoNettoTara5Fragment()
        ...
        if (savedInstanceState == null) {
            webView.loadUrl("https://www.youtube.com/embed/xICavJJlY2s")
        }
    }
