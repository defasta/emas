...
import app.hardika.emas.databinding.FragmentDiskonPajak7Binding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class DiskonPajak7Fragment : BaseFragment<FragmentDiskonPajak7Binding>(
    FragmentDiskonPajak7Binding:: inflate
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            ...
            val direction =
                app.hardika.emas.ui.kegiatan_belajar.diskon_pajak.fragment.DiskonPajak7FragmentDirections.actionDiskonPajak7FragmentToDiskonPajak8Fragment()
        ...
        if (savedInstanceState == null) {
            webView.loadUrl("https://www.youtube.com/embed/4UKdCZPfD24")
        }
