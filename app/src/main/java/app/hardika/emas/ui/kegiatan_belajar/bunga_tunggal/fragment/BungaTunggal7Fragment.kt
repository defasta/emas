...
import app.hardika.emas.databinding.FragmentBungaTunggal7Binding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class BungaTunggal7Fragment : BaseFragment<FragmentBungaTunggal7Binding>(
    FragmentBungaTunggal7Binding:: inflate
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            ...
            val direction =
                app.hardika.emas.ui.kegiatan_belajar.bunga_tunggal.fragment.BungaTunggal7FragmentDirections.actionBungaTunggal7FragmentToBungaTunggal8Fragment()
        ...
        if (savedInstanceState == null) {
            webView.loadUrl("https://www.youtube.com/embed/EUU_hsrqA9g")
        }
    }
