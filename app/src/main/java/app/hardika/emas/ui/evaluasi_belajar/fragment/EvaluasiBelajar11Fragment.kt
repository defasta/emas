...
import app.hardika.emas.databinding.FragmentEvaluasiBelajar11Binding
...
@AndroidEntryPoint
class EvaluasiBelajar11Fragment : BaseFragment<FragmentEvaluasiBelajar11Binding>(
    FragmentEvaluasiBelajar11Binding:: inflate
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnChooseA.setOnClickListener {
            ...
            val direction =
                app.hardika.emas.ui.evaluasi_belajar.fragment.EvaluasiBelajar11FragmentDirections.actionEvaluasiBelajar11FragmentToEvaluasiBelajar12Fragment()
            evaluasiBelajarNavController?.navigate(direction)
        }

        binding.btnChooseB.setOnClickListener {
            lifecycleScope.launch {
                viewModel.saveAnswerEb11("B")
            }
            val direction =
                app.hardika.emas.ui.evaluasi_belajar.fragment.EvaluasiBelajar11FragmentDirections.actionEvaluasiBelajar11FragmentToEvaluasiBelajar12Fragment()
            evaluasiBelajarNavController?.navigate(direction)
