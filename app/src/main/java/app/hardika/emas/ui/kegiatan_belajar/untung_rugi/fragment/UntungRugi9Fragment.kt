...
import app.hardika.emas.databinding.FragmentUntungRugi9Binding
...
@AndroidEntryPoint
class UntungRugi9Fragment : BaseFragment<FragmentUntungRugi9Binding>(
    FragmentUntungRugi9Binding:: inflate
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            ...
            val direction =
                app.hardika.emas.ui.kegiatan_belajar.untung_rugi.fragment.UntungRugi9FragmentDirections.actionUntungRugi9FragmentToUntungRugi10Fragment()
        ...
        if (savedInstanceState == null) {
            webView.loadUrl("https://www.youtube.com/embed/LsNVh3q0uqY")
        }
